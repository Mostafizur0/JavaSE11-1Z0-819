...
public class Literals {
    public static void main(String[] args) {
        ...
        long l = 127;// l = 127
        float f = 127;// f = 127.0
        double d = 127;// d = 127.0

        // boolean can only be set to true or false
        boolean isTrue = false;// isTrue = false
        ...
        float f2 = 127f;// f2 = 127.0
        float f3 = 127F;// f3 = 127.0
        System.out.println("f2 = " + f2);
        System.out.println("f3 = " + f3);

        double d2 = 127d;// d2 = 127.0
        double d3 = 127D;// d3 = 127.0
        System.out.println("d2 = " + d2);
        System.out.println("d3 = " + d3);

        float f4 = 1.27e02f;// f4 = 127.0
        double d4 = 1.27e02;// d4 = 127.0
        System.out.println("f4 = " + f4);
        System.out.println("d4 = " + d4);

        byte b4 = 0b1111111;   // binary 127 prefix 0b
        System.out.println("b4 = " + b4);// b4 = 127

        short s4 = 0177;  // octal 127 - octal prefix 0 only
        System.out.println("s4 = " + s4);// s4 = 127

        int i4 = 0x007F; // hexadecimal 127 - hex prefix 0x
        System.out.println("i4 = " + i4);// i4 = 127
        ...
        byte b7 = 0b0000_0001;// b7 = 1
        char c7 = 0x0_07F;// c7 = 
        short s7 = 011_11;// s7 = 585
        int i7 = 1_000_000;// i7 = 1000000
        long d7 = 1_000_000L;// d7 = 1000000
        float f7 = 1_000.000_000f;// f7 = 1000.0
        double l7 = 1.000_0000e10;// l7 = 1.0E10
